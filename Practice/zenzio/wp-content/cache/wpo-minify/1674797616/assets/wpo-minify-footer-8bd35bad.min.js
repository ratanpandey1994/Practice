...
jQuery(document).ready(function($){$(window).scroll(function(){if($(this).scrollTop()>1){$('.header-main').addClass("sticky")}else{$('.header-main').removeClass("sticky")}});function close_accordion_section(){$('.accordion .accordion-section-title').removeClass('active');$('.accordion .accordion-section-content').slideUp(300).removeClass('open')}
...
e.preventDefault()});$('ul.tablinkSec li a').click(function(){var t=$(this).attr('data-rel');$('ul.tablinkSec li a').removeClass('active');$(this).addClass('active');$('.tabcontentSec').hide();$('#'+t).show()});$('.navigation-wrapper a, .btn').on('click',function(e){if(this.hash!=""){e.preventDefault();var hash=this.hash;$('html, body').animate({scrollTop:$(hash).offset().top-70},1000);if($(window).width()<767){$('html, body').animate({scrollTop:$(hash).offset().top-70},1000)}}});if($(window).width()<768){$(".navigation-wrapper .hamburger").click(function(){$(".navigation-wrapper .menu-main-menu-container").slideToggle();$(this).toggleClass('close')});$(".navigation-wrapper li a").click(function(){$(".navigation-wrapper .menu-main-menu-container").slideUp();$('.navigation-wrapper .hamburger').removeClass('close')})}});
