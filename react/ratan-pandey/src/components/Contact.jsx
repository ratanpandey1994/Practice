...
const socialLinks = [
    {
        href: 'https://github.com/ratanpandey1994',
    ...
    {
        href: 'https://www.linkedin.com/in/ratan-pandey/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://x.com/ratanpandey121',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://www.instagram.com/ratanp7139/',
        ...
        <section id='contact' className='section'>
            <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
                <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                    <h2 className='headline-2 lg:max-w-[12ch] reveal-up'>Get in touch for collaboration</h2>
                    <p className='text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up'>
                        Contact me today to explore your project needs and begin creating something extraordinary!
                    </p>
                ...
                <form action='https://getform.io/f/blllwemb' className='xl:pl-10 2xl:pl-20' method='POST'>
                    <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                        <div className='mb-4'>
                            <label htmlFor='name' className='label reveal-up'>
                                Name
                            </label>
                            <input type='text' name='name' id='name' autoComplete='name' required placeholder='Ratan Pandey' className='text-field reveal-up' />
                        </div>
                        <div className='mb-4'>
                            <label htmlFor='email' className='label reveal-up'>
                                Email
                            </label>
                            <input type='email' name='email' id='email' autoComplete='email' required placeholder='ratan.pandey1994@gmail.com' className='text-field reveal-up' />
                        </div>
                    </div>
                    ...
                    <div className='mb-4'>
                        <div className=''>
                            ...
                            <textarea id='message' name='message' placeholder='Hi' className='text-field resize-y min-h-32 max-h-80 reveal-up'></textarea>
                        </div>
                    </div>
